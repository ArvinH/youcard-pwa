...
export const getCardStack = (cardstackId = '83775e20-83bb-11e6-b1c9-2727e3ec36ef') => {
  return (dispatch) => {
    ...
    fetch(`http://localhost:1337/tw.yql.news.yahoo.com/v1/abunews/cardstack/${cardstackId}`, { mode: 'no-cors' })
...
export const getCardList = () => {
  return (dispatch) => {
    ...
    dispatch(showSpinner());
    fetch('http://localhost:1337/tw.yql.news.yahoo.com/v1/abunews/cardstack_search_advance')
      .then(response => response.json())
      .then((json) => {
